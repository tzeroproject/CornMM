    ...
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <form onSubmit={handleSave} className="space-y-5">
        ...
        <div className="p-5 rounded-2xl bg-[#0a0a0a] border border-white/10 space-y-4">
          <div><label className="block text-xs font-semibold text-zinc-300 mb-1.5">Thumbnail</label><p className="text-[11px] text-zinc-500">Upload your own thumbnail. JPG, PNG, or WebP up to 10MB.</p></div>
